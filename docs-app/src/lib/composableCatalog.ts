...
const composableCatalog: UIComposableCatalogEntry[] = [
  {
    ...
    name: 'useConfirm',
    slug: slugifyComposableName('useConfirm'),
  ...
  },
  {
    ...
    name: 'useContent',
    slug: slugifyComposableName('useContent'),
  ...
  },
  {
    ...
    name: 'useI18n',
    slug: slugifyComposableName('useI18n'),
  ...
  },
  {
    ...
    name: 'useId',
    slug: slugifyComposableName('useId'),
  ...
  },
  {
    ...
    name: 'useInput',
    slug: slugifyComposableName('useInput'),
  ...
  },
  {
    ...
    name: 'useSettings',
    slug: slugifyComposableName('useSettings'),
  ...
  },
  {
    ...
    name: 'useSearch',
    slug: slugifyComposableName('useSearch'),
...
export function getComposableBySlug(slug: string) {
  return composableCatalog.find((entry) => entry.slug === slug)
}
...
export function slugifyComposableName(name: string) {
  return name
    .trim()
