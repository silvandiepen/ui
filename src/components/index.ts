...
export * from './Icon'
export * from './IkkiAppShell'
export * from './IkkiHeader'
export * from './IkkiSidebar'
export * from './MikkiFooter'
export * from './Kbd'
...
export { IkkiAppShell as UIIkkiAppShell } from './IkkiAppShell'
export { IkkiHeader as UIIkkiHeader } from './IkkiHeader'
export { IkkiSidebar as UIIkkiSidebar } from './IkkiSidebar'
export { MikkiFooter as UIMikkiFooter } from './MikkiFooter'
...
export { PillHeader as UIPillHeader } from './PillHeader'
