...
// Prefer InputText for regular single-line text fields. Input remains available for legacy T* namespace surfaces.
...
export { InputText as UIInput } from './InputText'
