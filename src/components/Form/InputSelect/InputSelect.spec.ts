...
describe('InputSelect', () => {
  ...
  it('renders InputCustomSelect when filterable is enabled', () => {
    const wrapper = mount(InputSelect, {
      props: {
        options: objectOptions,
        filterable: true
    ...
    const customSelect = wrapper.getComponent(InputCustomSelect)
    expect(customSelect.props('searchable')).toBe(true)
    expect(customSelect.props('options')).toEqual(objectOptions)
  })

  it('treats searchable as a legacy alias for filterable', () => {
    const wrapper = mount(InputSelect, {
      props: {
        options: objectOptions,
        searchable: true
    ...
    expect(wrapper.findComponent(InputCustomSelect).exists()).toBe(true)
  })
