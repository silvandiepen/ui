    ...
    <div :class="bemm('container', { error: !!error, disabled, readonly })">
      ...
      <div v-if="editor && !readonly" :class="bemm('toolbar')">
        ...
        <div :class="bemm('toolbar-group')">
          ...
          >
            <Icon :name="Icons.TEXT_BOLD" size="small" />
          </button>
          ...
          >
            <Icon :name="Icons.TEXT_ITALIC" size="small" />
          </button>
          ...
          >
            <Icon :name="Icons.TEXT_UNDERLINE" size="small" />
          </button>
          ...
          >
            <Icon :name="Icons.TEXT_LINE_THROUGH" size="small" />
          </button>
          ...
          >
            <Icon :name="Icons.CODE_BRACKETS" size="small" />
          </button>
        </div>
        ...
        <div :class="bemm('toolbar-group')">
          ...
          >
            <Icon :name="Icons.LIST_UNORDERED" size="small" />
          </button>
          ...
          >
            <Icon :name="Icons.QUOTE" size="small" />
          </button>
        </div>
        ...
        <div v-if="hasFeature('link')" :class="bemm('toolbar-group')">
          ...
          >
            <Icon :name="Icons.LINK" size="small" />
          </button>
        </div>
        ...
        <div :class="bemm('toolbar-group')">
          ...
          >
            <Icon :name="Icons.ARROW_RETURN_LEFT" size="small" />
          </button>
          ...
          >
            <Icon :name="Icons.ARROW_RETURN_RIGHT" size="small" />
          </button>
        </div>
      </div>
...
import type { RichTextEditorProps } from './RichTextEditor.model'
