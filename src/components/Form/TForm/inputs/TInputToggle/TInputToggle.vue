...
import type { TInputToggleProps, TInputToggleEmits } from './TInputToggle.model'

const model = defineModel<boolean>({
	default: false,
});

withDefaults(defineProps<TInputToggleProps>(), {
	label: '',
	error: () => [],
	showIcon: true,
	disabled: false,
...
const emit = defineEmits<TInputToggleEmits>()
