<!-- TInputCustomSelect.vue -->
<script lang="ts" setup>
import { computed, ref, watch, nextTick, onUnmounted } from 'vue'
import { useBemm } from 'bemm'
import InputBase from '../../InputBase.vue'
import Icon from '../../../../Icon/Icon.vue'
import type { TInputCustomSelectProps, TInputCustomSelectEmits, CustomOption } from './TInputCustomSelect.model'
...
const props = withDefaults(defineProps<TInputCustomSelectProps>(), {
...
const emit = defineEmits<TInputCustomSelectEmits>()
...
.input-custom-select {
  ...
  &__search-input {
    ...
    padding-left: calc(var(--space-m) + var(--input-custom-select-search-icon-size));
  ...
  &__search-icon {
    position: absolute;
    left: calc(var(--space-m) + var(--space-s));
    top: 50%;
